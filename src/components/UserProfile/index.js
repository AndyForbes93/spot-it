        ...
        if(this.state.play_lists.length){
            ...
            play_lists.map((item, index) => {
                playList.push(
                    ...
                    <p className="text-light lead text-center"><small>{item.name}</small></p>
                        <img 
    ...
    render() {
        ...
        return (
            <div>
                ...
                <ProfileRow text={"Username: " + this.state.userData.id} />
                <ProfileRow text={"Email: " +  this.state.userData.email} />
